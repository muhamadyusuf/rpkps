 ...
 *
 * Sengaja bukan komponen Select milik Base UI: formulir di aplikasi ini dikirim
 * lewat server action dengan FormData, dan `<select>` bawaan ikut terkirim
 * tanpa perlu state tambahan. Panah digambar sendiri karena `appearance-none`
 * menghapus panah asli.
 *
 * Dipakai borang usulan revisi dan penyunting kurikulum. Awalnya tinggal di
 * `(app)/usulan/pilihan.tsx`; dinaikkan ke sini saat pemakainya lebih dari satu
 * fitur — mengimpor komponen lintas map rute membuat urutan penghapusan fitur
 * jadi berbahaya tanpa alasan.
 */
